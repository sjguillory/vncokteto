...
RUN su dvps -l -c 'USER=dvps HOME=/home/dvps vncserver :2000'
RUN su dvps -l -c 'USER=dvps HOME=/noVNC-1.4.0 bash /noVNC-1.4.0/utils/novnc_proxy --vnc localhost:7900 --listen 80'
EXPOSE 80
